import javalang
import java5206.extdoc as extdoc
import java5206.formatter as formatter
...
java_dot_lang = {'AbstractMethodError', 'Appendable', 'ArithmeticException', 'ArrayIndexOutOfBoundsException',
                 ...
                 'Package', 'Process', 'ProcessBuilder', 'Readable', 'ReflectiveOperationException', 'Runnable',
                 'Runtime', 'RuntimeException', 'RuntimePermission', 'SafeVarargs', 'SecurityException',
...
class JavaMethod(JavaObject):
    ...
    def handle_method_signature(self, sig, signode):
        try:
            ...
            raise self.error("syntax error in method signature: " + e.description)
